...
public class GlavnaiKabinet extends AppCompatActivity {
    ...
    private String namekabinet;
    private String den_n="Понедельник";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_glavnai_kabinet);
        ...
        while (cursor.moveToNext()) {
            ...
            while (cursor6.moveToNext()) {
                ...
                if (id_kabineta == id_kab) {
                    if(id_kabineta==global.DD){
                    namekabinet = nomer_kabinet;
                    }
                }
            }
            cursor6.close();
        ...
        this.setTitle(namekabinet+" "+den_n);
        getPara();
        getData(den_n);
                    ...
                    if(id_predmeta_gruppi==id_pg){
                        ...
                        while (cursor5.moveToNext())
                        {
                            ...
                            if(idppp==idpredpoprep){
                                ...
                                cursor4.close();
                                String gr_predmet_kab=namegr+" "+predme;
                                //фио, предмет, день недели
                                if(namekab==global.DD){
                                    if(nomer_pari==1){
